          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              ...
              <div className="flex justify-between items-start mt-2">
                ...
                <Link to="/forgot-password" className="text-[11px] font-semibold text-white/50 hover:text-[#d66847] transition-colors ml-auto">
                  Forgot Password?
                </Link>
              </div>
            </div>
            ...
            <button
              type="button"
              className="relative w-full rounded-[14px] px-6 py-3.5 text-sm font-bold text-white bg-white/5 hover:bg-white/10 border border-white/10 transition-all active:scale-[0.98] flex items-center justify-center gap-3"
            >
               <svg viewBox="0 0 24 24" className="w-5 h-5 bg-white rounded-full p-[3px]" xmlns="http://www.w3.org/2000/svg">
