    ...
    <div className="flex h-screen bg-[#F4F8F7] font-sans text-gray-800">
      ...
      <aside className="w-64 bg-[#F4F8F7] border-r border-gray-200 flex flex-col shrink-0">
        ...
        <nav className="flex-1 px-4 mt-6 space-y-1">
          ...
          {/* Active Reviews Item */}
          <Link to="/manage-reviews" className="flex items-center px-4 py-3 bg-[#EAEFEF] text-gray-900 rounded-lg relative mt-1">
            ...
            <span className="font-medium text-[#A7412A]">Review</span>
          </Link>
