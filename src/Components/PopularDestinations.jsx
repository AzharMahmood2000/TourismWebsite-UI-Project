	...
	return (
		<section id="destinations" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
			...
			<div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
				{destinationRegistry.map((destination) => {
					return (
						<Link
							key={destination.id}
						...
						>
							<article>
								<div className="relative h-72 overflow-hidden">
									...
									/>
									<span className="absolute bottom-4 left-4 rounded-full bg-white/95 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-700">
