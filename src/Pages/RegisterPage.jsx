      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            {/* Full Name */}
            <div>
              <label htmlFor="reg-name" className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2">
                Full Name
              </label>
              <input
                id="reg-name"
            ...
            {/* Email */}
            <div>
              <label htmlFor="reg-email" className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2">
                Email Address
              </label>
              <input
                id="reg-email"
            ...
            {/* Password */}
            <div>
              <label htmlFor="reg-password" className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2">
                Password
              </label>
                  ...
                  <div className="flex gap-1">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        ...
                        style={{
                          background: i <= strengthScore ? strengthColor : 'rgba(255,255,255,0.15)',
                        }}
                      />
                    ))}
                  </div>
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="reg-confirm" className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2">
                Confirm Password
              </label>
              <input
                id="reg-confirm"
